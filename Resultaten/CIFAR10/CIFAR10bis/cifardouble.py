...
def augmentdata(inputs, targets, count=2):
	...
	for img, target in zip(inputs[:], targets[:]):
		...
		augmentedinputs.append(img[:,4:-4,4:-4])
		rescale24 = rescale(img,24,24)
		augmentedinputs.append(rescale24)
		rescale40 = rescale(img,40,40)
		augmentedinputs.append(rescale40[:,8:-8,8:-8])	
		augmentedtargets.append(target)
		augmentedtargets.append(target)
		augmentedtargets.append(target)

		augmentedinputs.append(flipimage(img[:,4:-4,4:-4]))
		augmentedinputs.append(flipimage(rescale24))
		augmentedinputs.append(flipimage(rescale40[:,8:-8,8:-8]))
		augmentedtargets.append(target)
		augmentedtargets.append(target)
		augmentedtargets.append(target)

		for i in range(count):
			augimg = augmenttranslate(img, -4, 4)
			augmentedinputs.append(augimg)
			augmentedinputs.append(flipimage(augimg))
			augmentedtargets.append(target)
			augmentedtargets.append(target)
			augimg = augmenttranslate(rescale40, -8, 8)
			augmentedinputs.append(augimg)
			augmentedinputs.append(flipimage(augimg))
			augmentedtargets.append(target)
			augmentedtargets.append(target)
	...
	return np.asarray(augmentedinputs), np.asarray(augmentedtargets)
